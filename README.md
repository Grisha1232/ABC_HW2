...
* Добавлена возможность запустить тест для замера времени с выводом времени. ([тут можно посмотреть на замеры времени](https://github.com/Grisha1232/ABC_HW2/blob/e6558f8377c4042e235c4354c8618c36a710174b/Time%20Test/test.md))
...
|:--------------------------------:|:-----------:|:----------:|:-----------:|:------------------------------:|:----------------------:|
| [C code](https://github.com/Grisha1232/ABC_HW2/tree/main/C%20code)                           | 4596        | 4507       | 4554        | 22.5                           | 248                    |
| [Ассемблерная программа (non Mod)](https://github.com/Grisha1232/ABC_HW2/tree/main/Assembler%20non%20mod) | 4791        | 5043       | 4691        | 16.7                           | 1033                   |
| [Ассемблерная программа](https://github.com/Grisha1232/ABC_HW2/tree/main/Assembler)           | 3402        | 3482       | 3467        | 16.6                           | 941                    |
